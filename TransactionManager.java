...
public class TransactionManager {
    ...
    public void updateTransaction(String id, Transaction updatedTransaction) {
        for (Transaction transaction : transactions) {
            if (transaction.getId().equals(id)) {
                double amountDifference = updatedTransaction.getAmount() - transaction.getAmount();
                if (!transaction.getType().equals(updatedTransaction.getType())) {
                    amountDifference = -transaction.getAmount() + updatedTransaction.getAmount();
                }
                updateBalance(amountDifference, updatedTransaction.getType());
    ...
    public void deleteTransactionsByCategory(String category) {
        ...
        transactions.removeIf(transaction -> transaction.getCategory().equals(category));
        saveTransactionsToFile();
    }
